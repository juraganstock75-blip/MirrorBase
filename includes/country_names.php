<?php
// includes/country_names.php — mapping kode ISO 3166-1 alpha-2 → nama negara
declare(strict_types=1);

function country_name(?string $cc): ?string {
    if (!$cc || strlen($cc) !== 2) {
        return null;
    }
    ...
    static $map = [
        ...
        'cf'=>'Central African Republic','td'=>'Chad','cl'=>'Chile','cn'=>"People's Republic of China",
        ...
        'kp'=>'North Korea','kr'=>'Republic of Korea','kw'=>'Kuwait','kg'=>'Kyrgyzstan',
        ...
        'hk'=>'Hong Kong','mo'=>'Macau','pr'=>'Puerto Rico','xk'=>'Kosovo',
    ];
